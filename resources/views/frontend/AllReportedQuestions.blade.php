    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">All Reported Qustions
                </h1>
                <h3 class="mt-4" style=" font-weight:400; ">Total reported questions: <span class="fs-5" id="user-count"
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('public/frontend/media/noReportedQuestion.svg') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
                <!--end::Card body-->
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getReportedQuestions') }}?page=' + page + '&search=' + search + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
            success: function(response) {
                var reportedQuestions = response.reportedQuestions;
                ...
                if (reportedQuestions.data.length === 0) {
                    // If no users found, display a message in a new row
                    var noUserRow = `
            <tr>
                <td colspan="6" class="text-center pt-10 fw-bolder fs-2">No Question found</td>
            </tr>
        `;
                ...
                var totalPages = reportedQuestions.last_page;
                var currentPage = reportedQuestions.current_page;
