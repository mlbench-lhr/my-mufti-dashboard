    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">All Scholars
                </h1>
                <h3 class="mt-4" style=" font-weight:400; ">Total Scholars: <span class="fs-5" id="user-count"
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getScholars') }}?page=' + page + '&search=' + encodeURIComponent(search) + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
