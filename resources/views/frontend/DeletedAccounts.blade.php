    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Users Deleted Accounts
                </h1>
                <h3 class="mt-4" style=" font-weight:400; ">Total Deleted Accounts: <span class="fs-5" id="user-count"
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-dark fw-bold fs-5 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px text-right">Reason</th>
                                        <th class="min-w-125px text-center">Deleted On</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('public/frontend/media/noDeletedAccounts.svg') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
                <!--end::Card body-->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="reasonModalLabel">Deletion Reason</h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body fs-3" id="reasonModalBody">
                        <!-- Full reason will be injected here -->
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getDeletedAccounts') }}?page=' + page + '&search=' + encodeURIComponent(search) +
                '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
        ...
        `;
                    ...
                    $.each(users.data, function(index, row) {
                        ...
                        let formattedDate = row.deleted_at ? formatDate(row.deleted_at) : 'N/A';
    ...
    $(document).on("click", ".read-more", function() {
        var fullReason = $(this).data("reason");
        $("#reasonModalBody").text(fullReason);
    });
