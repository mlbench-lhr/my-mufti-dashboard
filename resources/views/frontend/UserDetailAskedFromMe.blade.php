        ...
        <div class="container-fluid" id="">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    @if (count($response['askedFromMufti']))
                        <!--begin::Table-->
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('public/frontend/media/askedFromMeEmpty.svg') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
                <!--end::Card body-->
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getUserAskedFromMe', ['id' => ':id']) }}'.replace(':id', user_id) + '?page=' +
