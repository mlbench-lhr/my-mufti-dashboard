    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Scholars Requests
                </h1>
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('public/frontend/media/noRequest.svg') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
                <!--end::Card body-->
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getScholarRequests') }}?page=' + page + '&search=' + encodeURIComponent(search) + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
