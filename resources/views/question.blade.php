...
<body>
    <div class="container">
        <div class="profile">
            <img src="{{ asset('storage/' . $question->user_detail->image) }}" alt="Profile" class="profile-image">
            <h2>{{ $question->user_detail->name }}</h2>
        </div>
            ...
            <div class="comment">
                ...
                <div class="comment-content">
                    ...
                    <p>All Scholar on our platform are verified and background checked. Feel free to ask any type of
                        question. The responsiveness at various breakpoints works really well.</p>
                </div>
            </div>
        </div>
