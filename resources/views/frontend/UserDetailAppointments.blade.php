        ...
        <div class="container-fluid" id="">
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class=" mb-5">
                        <!--begin::Title-->
                        <h3 class="mt-4" style=" font-weight:400; ">Total Appointmensts: <span class="fs-5"
                ...
                <div class="card-body pt-0">
                    ...
                    @if (count($response['appointments']))
                        <!--begin::Table-->
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('getUserAppointments', ['id' => ':id']) }}'.replace(':id', user_id) + '?page=' +
        ...
        `;
                    ...
                    $.each(users.data, function(index, row) {
                        var categoryName = row.mufti_detail.interests.map(function(interest) {
